...
if uploaded_file is not None:
    ...
    if view == 'Branch':
        ...
        with card_container(key="chart2"):
            ...
            fig2.update_layout(title={'text': 'This Week Daily Production', 'x': 0.5, 'xanchor': 'center'}, width=400, xaxis=dict(categoryorder='array', categoryarray=["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"] )) 
